...
public class Emergency {
    ...
    public void relax(int v1,Edge e,int v2){
        if (distTo[e.theOther(v1)] > distTo[v1]+e.Edgeweight) {
            distTo[e.theOther(v1)] = distTo[v1]+e.Edgeweight;
            if (e.theOther(v1)==v2){
                cnt =1;
            }
            NodeWeights[e.theOther(v1)] += vNodes[v1].nodeWeight;
        }
        else if (distTo[e.theOther(v1)] == distTo[v1]+e.Edgeweight){
            if (e.theOther(v1)==v2)    cnt += 1;
            if (NodeWeights[e.theOther(v1)] < vNodes[e.theOther(v1)].nodeWeight+ NodeWeights[v1] ) {
                NodeWeights[e.theOther(v1)] = vNodes[e.theOther(v1)].nodeWeight+ NodeWeights[v1];
            }
        }

    }

    public int getNodeWeight(int v){
        return NodeWeights[v];
    }
    ...
    public static void main(String[] args){
        ...
        System.out.print(cnt+" "+my.getNodeWeight(c2));
